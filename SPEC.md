...
| 2026-08-08 | 新增「交易员的正确之路」进度与解锁系统：集中式进度模块 `trader-road-progress.ts`、10 关卡 + 12 Agent 映射、SSR 安全 localStorage 读写、Agent 团队锁定态视觉（开发调试按钮已移除） |
