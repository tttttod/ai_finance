...
> 最后更新：2026-08-03
> 本次变更：全面重构产品定位，引入投资风格选择、12步Agent工作流、三情景预测、复盘系统
...
| `/research` | Agent 研究工作台 | 12步完整投研流程，支持风格选择 | 待实现 |
| `/review` | 复盘系统 | 跟踪候选标的表现，统计信号有效性 | 待实现 |
...
| Tab | 页面 | 核心功能 |
|-----|------|---------|
| 市场 | `/mini/market` | 今日 AI 摘要、指数卡片、板块热度榜、个股异动榜、事件时间轴 |
| 研究 | `/mini/research` | 股票输入、风格选择、16 步工作流、多 Agent 分析卡片、因子评分、辩论卡、情景预测 |
| 复盘 | `/mini/review` | 历史研究列表、预测 vs 实际曲线、准确率统计、风格表现对比 |
