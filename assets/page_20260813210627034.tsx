  ...
  return (
    <div className="relative mb-6 mt-10">
      <div className="absolute -left-4 -top-12 z-20 h-28 w-28">
        ...
        <div className="absolute -bottom-1 -right-1 flex h-9 w-9 rotate-[-10deg] items-center justify-center rounded-full border-2 border-[#8e673c] bg-[#f5e7c4] text-lg shadow-md">
          🔍
        </div>
      </div>
      ...
      <div className="relative ml-10 rounded-2xl border-2 border-[#9a764e] bg-[#f3dfb2] pb-4 pl-16 pr-4 pt-4 shadow-[0_7px_18px_rgba(83,52,28,0.17)]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <p className="text-xs font-black tracking-[0.1em] text-[#70472c]">
            FUNDAMENTAL AGENT
          </p>

          <span className="rounded-full bg-[#d9bd7b] px-2 py-0.5 text-[10px] font-bold text-[#5b402b]">
            基本面分析师
          </span>
        </div>
        ...
        <p className="mt-2 text-right text-[11px] italic text-[#98724d]">
          — Investigation Note
        </p>
      </div>
    </div>
        ...
        <div className="mb-6">
          <div className="mb-4 rounded-xl border border-[#8e673c] bg-[#3a2a20] px-4 py-3 text-[#f3dfb2] shadow-lg">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs tracking-[0.18em] text-[#c7a56a]">
                  CURRENT CASE
                </p>
              ...
              <div className="flex flex-col items-end gap-2">
                <div className="rounded-full bg-[#c7a56a] px-3 py-1 text-xs font-bold text-[#2b211a]">
                  STEP {step}/3
                </div>
                  ...
                  {[0, 1, 2].map((heart) => (
                    <span
                      ...
                      className={`text-lg transition ${
                        heart < lives ? "opacity-100" : "grayscale opacity-30"
                      }`}
                    >
                      ❤️
                    </span>
            ...
            <p className="mt-2 text-[11px] text-[#bda77d]">
              提交错误将失去 1 颗调查之心。
            </p>
          </div>

          <div className="text-center">
            <p className="text-sm tracking-[0.25em] text-[#c7a56a]">
              FUNDAMENTAL AGENT
            </p>

            <h1 className="mt-2 text-3xl font-bold text-[#f3dfb2]">
              财报侦探
            </h1>

            <p className="mt-2 text-sm text-[#cdb88d]">
              数字不会说谎，但数字之间可能藏着秘密。
            </p>
          </div>
        </div>
          ...
          <div className="relative">
            <div className="mb-5 border-b border-[#a98557] pb-4 text-center">
              <div className="mb-3 flex justify-center">
                <div className="rotate-[-2deg] rounded-md border-2 border-[#7b5734] bg-[#d8b77d] px-4 py-1 text-xs font-black tracking-[0.18em] text-[#4a321f] shadow-sm">
                  CASE FILE · 001
                </div>
              </div>

              <p className="text-xs tracking-[0.2em] text-[#7c5a37]">
                CONFIDENTIAL FILE
              </p>

              <h2 className="mt-1 text-xl font-bold text-[#3c2a1d]">
                星河科技 · 2025 年度财务档案
              </h2>
            </div>
                ...
                {[1, 2, 3].map((item) => (
                  <div
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold ${
                      step >= item
                        ? "bg-[#70472c] text-[#fff1d0]"
                        : "bg-[#d6bd8d] text-[#806344]"
                    }`}
                  >
                    {item}
                  </div>
            ...
            {gameOver && (
              <>
                <AgentHint>
                  “线索断了，但真正的研究员不会因为一次判断失误就放弃。重新梳理数字，再来一次。”
                </AgentHint>

                <div className="rounded-2xl border-2 border-[#8f2f25] bg-[#efd0bf] p-6 text-center shadow-md">
                  <div className="text-5xl">💔</div>

                  <h2 className="mt-3 text-2xl font-black text-[#7d3028]">
                    调查失败
                  </h2>

                  <p className="mt-3 text-sm leading-6 text-[#6d4035]">
                    三颗调查之心已经耗尽，案件暂时陷入僵局。
                  </p>

                  <p className="mt-2 text-xs text-[#8a5a4d]">
                    提示：不要单独盯着“涨了多少”，试着寻找不同财务数据之间的矛盾。
                  </p>

                  <button
                    type="button"
                    onClick={resetGame}
                    className="mt-5 w-full rounded-xl bg-[#70472c] py-3 font-bold text-[#fff1d0] shadow-md transition hover:bg-[#5b3822]"
                  >
                    重新调查 ❤️❤️❤️
                  </button>
                </div>
            ...
            {gameCleared && !gameOver && (
              <>
                <AgentHint>
                  “漂亮。你没有急着给公司定罪，而是一步步让数字、证据和调查方向互相验证。”
                </AgentHint>

                <div className="rounded-2xl border-2 border-[#52724c] bg-[#dce9cf] p-5 shadow-md">
                  <div className="mb-4 flex justify-center">
                    <div className="rotate-[-6deg] rounded-lg border-[3px] border-[#8f2f25] px-4 py-2 text-lg font-black tracking-[0.15em] text-[#8f2f25]">
                      调查完成
                    </div>
                  </div>
                  ...
                  <p className="mt-4 text-lg font-bold text-[#355037]">
                    案件结论
                  </p>

                  <p className="mt-2 text-sm leading-6 text-[#3f4937]">
                    你发现了利润、现金流、应收账款、客户集中度和收入确认时间之间的一组异常关系。
                    这不能直接证明公司存在财务造假，但已经足以支持进一步核查。
                  </p>

                  <p className="mt-3 text-sm font-semibold leading-6 text-[#355037]">
                    Fundamental Agent：
                    “真正的基本面研究，不是找到一个异常数字，而是让多个证据互相验证。”
                  </p>
                </div>
                ...
                <div className="mt-4 space-y-3">
                  <button
                    type="button"
                    onClick={() => onComplete?.()}
                    className="w-full rounded-xl bg-[#70472c] py-3 font-bold text-[#fff1d0] shadow-md transition hover:bg-[#5b3822]"
                  >
                    完成调查，继续旅程 →
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={resetGame}
                    className="w-full rounded-xl border border-[#8d6a42] py-3 font-semibold text-[#5b402b]"
                  >
                    重新挑战
                  </button>
                </div>
            ...
            {!gameOver && !gameCleared && step === 1 && (
              <>
                <div className="mb-4 rounded-xl border border-[#b99668] bg-[#f5e7c4] p-3">
                  <p className="text-sm leading-6 text-[#5a3e28]">
                    找出
                    <span className="mx-1 font-bold text-[#8e2f24]">
                      2 个
                    </span>
                    最值得进一步调查的财务指标。
                  </p>
                  ...
                  {financials.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative w-full rounded-xl p-4 text-left transition-all duration-200 ${
                          active
                            ? "rotate-[-0.4deg] border-[3px] border-[#9f3428] bg-[#f0c7ac] shadow-md"
                            : "border-2 border-[#b99564] bg-[#f8edcf] hover:bg-[#f4e4c1]"
                        }`}
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            <span className="font-semibold text-[#3a291d]">
                              {item.label}
                            </span>

                            <div className="mt-1 text-sm text-[#75543a]">
                              {item.value}
                            </div>
                          </div>
                          ...
                          <div className="relative shrink-0">
                            ...
                            {active && (
                              <>
                                ...
                                <span className="pointer-events-none absolute -right-5 -top-4 rotate-[12deg] text-2xl font-black text-[#a63b2e]">
                                  ?
                                </span>
                              </>
                            )}
                ...
                <div className="mt-4 flex items-center justify-between rounded-xl border border-[#b99564] bg-[#f5e7c4] px-4 py-3">
                  ...
                  <span className="font-bold text-[#6f4d31]">
                    {selectedFinancials.length} / 2
                  </span>
                </div>
                ...
                <button
                  ...
                  className="mt-5 w-full rounded-xl bg-[#70472c] py-3 font-bold text-[#fff1d0] shadow-md transition hover:bg-[#5b3822] disabled:cursor-not-allowed disabled:opacity-40"
                >
                  提交调查结果
                </button>
            ...
            {!gameOver && !gameCleared && step === 2 && (
              <>
                    ...
                    return (
                      <button
                        ...
                        className={`w-full rounded-xl border-2 p-4 text-left transition ${
                          active
                            ? "rotate-[-0.3deg] border-[#9f3428] bg-[#f0c7ac] shadow-md"
                      ...
                      >
                        ...
                        {active && (
                          <span className="ml-2 font-bold text-[#9f3428]">
                            ✓
                          </span>
                        )}
                      </button>
                ...
                <button
                  ...
                  className="mt-5 w-full rounded-xl bg-[#70472c] py-3 font-bold text-[#fff1d0] disabled:opacity-40"
                >
                  提交证据
                </button>
            ...
            {!gameOver && !gameCleared && step === 3 && (
              <>
                ...
                {step3Wrong && !gameOver && (
                  <div className="mt-4 rounded-xl border border-[#b56755] bg-[#efd0bf] p-4 text-sm leading-6 text-[#6f392f]">
                    <p className="font-bold">💔 调查方向偏离，失去 1 颗调查之心</p>
                    <p className="mt-1">
                      当前最重要的问题，是继续验证收入质量和回款情况。
                    </p>
                  </div>
                )}
              </>
