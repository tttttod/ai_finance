        ...
        {!gameOver && round === 3 && !round3Complete && (
          <>
              ...
              firstAction === "wait" && (
                <>
                  <section className="mt-5 rounded-[26px] border-2 border-[#f0c8e0] bg-[#fff0f8] p-6 text-center shadow-[0_12px_30px_rgba(200,120,170,0.12)]">
                    ...
                    <p className="mt-2 text-sm font-bold text-[#8a7187]">
                      看到它继续上涨，此刻最可能诱发你改变原计划的心理是什么？
                    </p>

                    <p className="mt-2 text-[11px] font-medium leading-5 text-[#9b7f94]">
                      注意：这里不是要求你“必须后悔”，而是在识别最典型的错失恐惧信号。
                    </p>
                    ...
                    {waitReflectionWrong && (
                      <p className="mt-3 text-xs font-bold text-[#c45252]">
                        💔 再想想：这里考的是哪种心理会因为“别人都在赚钱、自己可能错过”而诱发你改变原计划。
                      </p>
                    )}
            ...
            {fomoPhase === "boss" && (
              <>
                ...
                <section className="mt-5 rounded-[26px] border-2 border-[#f0c8e0] bg-[#fff0f8] p-6 shadow-[0_12px_30px_rgba(200,120,170,0.12)]">
                  ...
                  {bossWrong && (
                    <p className="mt-3 text-xs font-bold text-[#c45252]">
                      💔 “继续追涨”或“只等价格回调”都把价格本身当成了依据，却没有增加新的投资证据。
                    </p>
                  )}
            ...
            {fomoPhase === "evidence" && (
              <>
                <AgentMessage>
                  “很好。现在把情绪和事实放在一起看：哪组证据最直接支持‘这轮短期上涨更多由情绪推动，而不是基本面突然改善’？”
                </AgentMessage>
                ...
                <section className="mt-5 rounded-[26px] border-2 border-[#f0c8e0] bg-[#fff0f8] p-6 shadow-[0_12px_30px_rgba(200,120,170,0.12)]">
                  ...
                  {evidenceWrong && (
                    <p className="mt-3 text-xs font-bold text-[#c45252]">
                      💔 关键是把三件事连起来：基本面没有重大变化、价格却快速拉升，同时社区情绪极度狂热。
                    </p>
                  )}
