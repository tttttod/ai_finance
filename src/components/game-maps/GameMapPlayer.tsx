...
const WORLD_LOCATIONS: WorldLocation[] = [
  ...
  { id: 13, locationId: "hotspot-volcano", name: "热点火山与追涨火箭", subtitle: "Hotspot Volcano & Rocket", x: 75, y: 30, type: "game", gameId: "hotspot-volcano" },
  { id: 14, locationId: "review-lighthouse", name: "复盘灯塔", subtitle: "Review Lighthouse", x: 15, y: 70, type: "game", gameId: "review-lighthouse" },
];
