...
export const GAME_MAP_LEVELS: GameMapLevel[] = [
  ...
  { id: 9, title: "证据岔路口", subtitle: "Risk Officer", icon: "🏛️", type: "parliament", unlockAgents: ["risk"], color: "#EF4444", description: "热搜开庭，多空双方面对面辩论，用证据和失效条件寻找真相。" },
  { id: 10, title: "风险护盾桥", subtitle: "Research Manager", icon: "🏆", type: "risk", unlockAgents: ["manager"], color: "#14B8A6", description: "集结所有 Agent 力量，完成最终的研究报告。" },
];
