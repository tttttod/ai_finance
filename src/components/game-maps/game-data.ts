...
export const GAME_MAP_LEVELS: GameMapLevel[] = [
  ...
  { id: 5, title: "价格审判庭", subtitle: "Valuation Agent", icon: "\u2696\uFE0F", type: "dialogue", unlockAgents: ["valuation"], color: "#8B5CF6", description: "好公司也有价签 — 判断公司质量与买入价格能否同时成立" },
  ...
  { id: 7, title: "K线神谕", subtitle: "Technical Agent", icon: "\u{1F4C8}", type: "dialogue", unlockAgents: ["technical"], color: "#F97316", description: "图形会说话吗 — 检查价格位置和成交变化，决定入场时机与投入资金" },
