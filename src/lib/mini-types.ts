...
export const AGENT_UNLOCK_META: Record<AgentRole, AgentUnlockMeta> = {
  lead: {
    avatar: "/agent-lead.webp",
    fullBody: "/agent-lead-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 0,
    unlockHint: "初始即解锁，研究团队的核心领航者",
  },
  data: {
    avatar: "/agent-data.webp",
    fullBody: "/agent-data-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 1,
    unlockHint: "完成第 1 关「开户日」后解锁",
  },
  market: {
    avatar: "/agent-market.webp",
    fullBody: "/agent-market-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 2,
    unlockHint: "完成第 2 关「数据黑市」后解锁",
  },
  industry: {
    avatar: "/agent-industry.webp",
    fullBody: "/agent-industry-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 3,
  ...
  valuation: {
    ...
    fullBody: "/agent-valuation-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 4,
    unlockHint: "完成第 4 关「政策密函」后解锁",
  },
  technical: {
    avatar: "/agent-technical.webp",
    fullBody: "/agent-technical-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 5,
    unlockHint: "完成第 5 关「价格审判庭」后解锁",
  },
  sentiment: {
    avatar: "/agent-sentiment.webp",
    fullBody: "/agent-sentiment-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 6,
    unlockHint: "完成第 6 关「K线神谕」后解锁",
  },
  bull: {
    avatar: "/agent-bull.webp",
    fullBody: "/agent-bull-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 7,
    unlockHint: "完成第 7 关「多空议会」后解锁",
  },
  bear: {
    avatar: "/agent-bear.webp",
    fullBody: "/agent-bear-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 8,
    unlockHint: "完成第 8 关「舆论火场」后解锁",
  },
  risk: {
    avatar: "/agent-risk.webp",
    fullBody: "/agent-risk-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 9,
    unlockHint: "完成第 9 关「回撤之门」后解锁",
  },
  manager: {
    avatar: "/agent-manager.webp",
    fullBody: "/agent-manager-full.webp",
    lockedAvatar: "/agent-locked.webp",
    unlockLevel: 10,
    unlockHint: "完成第 10 关「最终关」后解锁",
  },
};
